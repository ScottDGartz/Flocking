...
// Horinzontal Distance to target is always fixed.
// For every one of those smoothed values, calculate the wanted value adn the current value.
// Smooth it using the Lerp function and aply the smoothed values to the transform's position.
